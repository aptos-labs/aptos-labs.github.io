...
//
// The literal "2026-08-30 06:34 UTC (aptos-framework devnet 09c0091; tooling aptos-core 0dfe6f57)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-08-30 06:34 UTC (aptos-framework devnet 09c0091; tooling aptos-core 0dfe6f57)</em>';
    main.appendChild(p);
  }

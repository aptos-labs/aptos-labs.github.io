...
//
// The literal "2026-09-06 06:34 UTC (aptos-framework devnet 96be453; tooling aptos-core a1c2b82d)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-09-06 06:34 UTC (aptos-framework devnet 96be453; tooling aptos-core a1c2b82d)</em>';
    main.appendChild(p);
  }

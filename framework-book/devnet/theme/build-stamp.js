...
//
// The literal "2026-07-07 07:26 UTC (aptos-framework devnet d32360b; tooling aptos-core 58b3d3ef)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-07-07 07:26 UTC (aptos-framework devnet d32360b; tooling aptos-core 58b3d3ef)</em>';
    main.appendChild(p);
  }

...
//
// The literal "2026-07-21 07:08 UTC (aptos-framework devnet 603dec3; tooling aptos-core ecfa2046)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-07-21 07:08 UTC (aptos-framework devnet 603dec3; tooling aptos-core ecfa2046)</em>';
    main.appendChild(p);
  }

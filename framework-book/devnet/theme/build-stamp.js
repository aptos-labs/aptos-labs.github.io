...
//
// The literal "2026-09-03 06:40 UTC (aptos-framework devnet 96be453; tooling aptos-core 893d1ffe)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-09-03 06:40 UTC (aptos-framework devnet 96be453; tooling aptos-core 893d1ffe)</em>';
    main.appendChild(p);
  }

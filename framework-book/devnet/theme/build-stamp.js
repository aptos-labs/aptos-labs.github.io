...
//
// The literal "2026-09-22 06:40 UTC (aptos-framework devnet 96be453; tooling aptos-core 050dbbe0)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-09-22 06:40 UTC (aptos-framework devnet 96be453; tooling aptos-core 050dbbe0)</em>';
    main.appendChild(p);
  }

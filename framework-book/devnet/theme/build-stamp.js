...
//
// The literal "2026-06-28 07:38 UTC (aptos-framework devnet d32360b; tooling aptos-core f3e3806f)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-06-28 07:38 UTC (aptos-framework devnet d32360b; tooling aptos-core f3e3806f)</em>';
    main.appendChild(p);
  }

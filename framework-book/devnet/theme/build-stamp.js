...
//
// The literal "2026-07-22 07:09 UTC (aptos-framework devnet 603dec3; tooling aptos-core 7f54b894)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-07-22 07:09 UTC (aptos-framework devnet 603dec3; tooling aptos-core 7f54b894)</em>';
    main.appendChild(p);
  }

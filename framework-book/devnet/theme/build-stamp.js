...
//
// The literal "2026-06-11 08:01 UTC (aptos-framework devnet 5af6e82; tooling aptos-core 21438b31)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-06-11 08:01 UTC (aptos-framework devnet 5af6e82; tooling aptos-core 21438b31)</em>';
    main.appendChild(p);
  }

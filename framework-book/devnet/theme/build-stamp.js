...
//
// The literal "2026-07-02 07:24 UTC (aptos-framework devnet d32360b; tooling aptos-core 75222b22)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-07-02 07:24 UTC (aptos-framework devnet d32360b; tooling aptos-core 75222b22)</em>';
    main.appendChild(p);
  }

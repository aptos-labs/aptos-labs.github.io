...
//
// The literal "2026-09-13 06:40 UTC (aptos-framework devnet 96be453; tooling aptos-core 0ef358e7)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-09-13 06:40 UTC (aptos-framework devnet 96be453; tooling aptos-core 0ef358e7)</em>';
    main.appendChild(p);
  }

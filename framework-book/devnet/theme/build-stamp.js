...
//
// The literal "2026-09-26 06:38 UTC (aptos-framework devnet 96be453; tooling aptos-core f5f07ca0)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-09-26 06:38 UTC (aptos-framework devnet 96be453; tooling aptos-core f5f07ca0)</em>';
    main.appendChild(p);
  }

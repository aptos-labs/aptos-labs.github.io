...
//
// The literal "2026-07-17 07:04 UTC (aptos-framework devnet 603dec3; tooling aptos-core 74f4acc1)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-07-17 07:04 UTC (aptos-framework devnet 603dec3; tooling aptos-core 74f4acc1)</em>';
    main.appendChild(p);
  }

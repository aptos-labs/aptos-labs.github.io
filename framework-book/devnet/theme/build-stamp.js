...
//
// The literal "2026-07-29 07:10 UTC (aptos-framework devnet 603dec3; tooling aptos-core e2806a14)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-07-29 07:10 UTC (aptos-framework devnet 603dec3; tooling aptos-core e2806a14)</em>';
    main.appendChild(p);
  }

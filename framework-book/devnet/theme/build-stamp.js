...
//
// The literal "2026-06-04 07:55 UTC (aptos-framework devnet 7e1333e; tooling aptos-core 6a67410c)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-06-04 07:55 UTC (aptos-framework devnet 7e1333e; tooling aptos-core 6a67410c)</em>';
    main.appendChild(p);
  }

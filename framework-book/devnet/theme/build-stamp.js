...
//
// The literal "2026-07-28 07:09 UTC (aptos-framework devnet 603dec3; tooling aptos-core 28f82080)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-07-28 07:09 UTC (aptos-framework devnet 603dec3; tooling aptos-core 28f82080)</em>';
    main.appendChild(p);
  }

...
//
// The literal "2026-09-19 06:36 UTC (aptos-framework devnet 96be453; tooling aptos-core eba5dea4)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-09-19 06:36 UTC (aptos-framework devnet 96be453; tooling aptos-core eba5dea4)</em>';
    main.appendChild(p);
  }

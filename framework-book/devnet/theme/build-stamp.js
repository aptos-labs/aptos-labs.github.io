...
//
// The literal "2026-06-26 07:36 UTC (aptos-framework devnet d32360b; tooling aptos-core 70915349)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-06-26 07:36 UTC (aptos-framework devnet d32360b; tooling aptos-core 70915349)</em>';
    main.appendChild(p);
  }

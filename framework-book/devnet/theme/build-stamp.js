...
//
// The literal "2026-07-10 07:27 UTC (aptos-framework devnet d32360b; tooling aptos-core 31ff67be)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-07-10 07:27 UTC (aptos-framework devnet d32360b; tooling aptos-core 31ff67be)</em>';
    main.appendChild(p);
  }

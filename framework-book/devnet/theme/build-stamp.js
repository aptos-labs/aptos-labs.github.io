...
//
// The literal "2026-09-07 06:49 UTC (aptos-framework devnet 96be453; tooling aptos-core 5f8e94a9)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-09-07 06:49 UTC (aptos-framework devnet 96be453; tooling aptos-core 5f8e94a9)</em>';
    main.appendChild(p);
  }

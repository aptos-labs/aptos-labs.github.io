...
//
// The literal "2026-07-26 07:10 UTC (aptos-framework devnet 603dec3; tooling aptos-core 8873921d)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-07-26 07:10 UTC (aptos-framework devnet 603dec3; tooling aptos-core 8873921d)</em>';
    main.appendChild(p);
  }

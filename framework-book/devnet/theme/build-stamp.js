...
//
// The literal "2026-07-08 07:07 UTC (aptos-framework devnet d32360b; tooling aptos-core b7e72f77)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-07-08 07:07 UTC (aptos-framework devnet d32360b; tooling aptos-core b7e72f77)</em>';
    main.appendChild(p);
  }

...
//
// The literal "2026-06-12 07:57 UTC (aptos-framework devnet 5af6e82; tooling aptos-core a3c9cc8c)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-06-12 07:57 UTC (aptos-framework devnet 5af6e82; tooling aptos-core a3c9cc8c)</em>';
    main.appendChild(p);
  }

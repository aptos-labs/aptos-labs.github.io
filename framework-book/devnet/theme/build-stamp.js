...
//
// The literal "2026-09-25 06:41 UTC (aptos-framework devnet 96be453; tooling aptos-core ab5b6cbc)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-09-25 06:41 UTC (aptos-framework devnet 96be453; tooling aptos-core ab5b6cbc)</em>';
    main.appendChild(p);
  }

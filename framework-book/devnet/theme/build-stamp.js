...
//
// The literal "2026-08-21 06:25 UTC (aptos-framework devnet 09c0091; tooling aptos-core 8ea60bf5)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-08-21 06:25 UTC (aptos-framework devnet 09c0091; tooling aptos-core 8ea60bf5)</em>';
    main.appendChild(p);
  }

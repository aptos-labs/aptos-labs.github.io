...
//
// The literal "2026-07-19 07:07 UTC (aptos-framework devnet 603dec3; tooling aptos-core e7f5c20c)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-07-19 07:07 UTC (aptos-framework devnet 603dec3; tooling aptos-core e7f5c20c)</em>';
    main.appendChild(p);
  }

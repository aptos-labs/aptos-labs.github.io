...
//
// The literal "2026-07-23 07:07 UTC (aptos-framework devnet 603dec3; tooling aptos-core dea1e962)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-07-23 07:07 UTC (aptos-framework devnet 603dec3; tooling aptos-core dea1e962)</em>';
    main.appendChild(p);
  }

...
//
// The literal "2026-09-18 06:39 UTC (aptos-framework devnet 96be453; tooling aptos-core b683b501)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-09-18 06:39 UTC (aptos-framework devnet 96be453; tooling aptos-core b683b501)</em>';
    main.appendChild(p);
  }

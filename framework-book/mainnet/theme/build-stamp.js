...
//
// The literal "2026-06-14 07:53 UTC (aptos-framework mainnet eea778c; tooling aptos-core 97c5e1e5)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-06-14 07:53 UTC (aptos-framework mainnet eea778c; tooling aptos-core 97c5e1e5)</em>';
    main.appendChild(p);
  }

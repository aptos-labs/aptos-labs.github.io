...
//
// The literal "2026-06-01 08:12 UTC (aptos-framework mainnet 5685537; tooling aptos-core 85b73187)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-06-01 08:12 UTC (aptos-framework mainnet 5685537; tooling aptos-core 85b73187)</em>';
    main.appendChild(p);
  }

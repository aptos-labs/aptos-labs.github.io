...
//
// The literal "2026-06-08 08:06 UTC (aptos-framework mainnet eea778c; tooling aptos-core 226bc17e)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-06-08 08:06 UTC (aptos-framework mainnet eea778c; tooling aptos-core 226bc17e)</em>';
    main.appendChild(p);
  }

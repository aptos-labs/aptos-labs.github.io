...
//
// The literal "2026-05-27 07:45 UTC (aptos-framework testnet 33e99b1; tooling aptos-core c0b463c1)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-05-27 07:45 UTC (aptos-framework testnet 33e99b1; tooling aptos-core c0b463c1)</em>';
    main.appendChild(p);
  }

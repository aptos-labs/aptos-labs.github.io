...
//
// The literal "2026-06-05 07:48 UTC (aptos-framework testnet 5a1d2c0; tooling aptos-core e3f1cd87)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-06-05 07:48 UTC (aptos-framework testnet 5a1d2c0; tooling aptos-core e3f1cd87)</em>';
    main.appendChild(p);
  }

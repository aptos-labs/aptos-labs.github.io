...
//
// The literal "2026-05-29 07:40 UTC (aptos-framework testnet 5a1d2c0; tooling aptos-core 16070809)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-05-29 07:40 UTC (aptos-framework testnet 5a1d2c0; tooling aptos-core 16070809)</em>';
    main.appendChild(p);
  }

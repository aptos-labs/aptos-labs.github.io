...
//
// The literal "2026-06-13 07:35 UTC (aptos-framework testnet 5a1d2c0; tooling aptos-core 46b57c32)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-06-13 07:35 UTC (aptos-framework testnet 5a1d2c0; tooling aptos-core 46b57c32)</em>';
    main.appendChild(p);
  }

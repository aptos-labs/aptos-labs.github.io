...
//
// The literal "2026-05-24 07:23 UTC (aptos-framework testnet 33e99b1; tooling aptos-core d1d83dfb)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-05-24 07:23 UTC (aptos-framework testnet 33e99b1; tooling aptos-core d1d83dfb)</em>';
    main.appendChild(p);
  }

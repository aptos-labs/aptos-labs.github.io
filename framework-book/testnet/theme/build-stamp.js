...
//
// The literal "2026-09-04 06:39 UTC (aptos-framework testnet ad8f79a; tooling aptos-core 89cc1522)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-09-04 06:39 UTC (aptos-framework testnet ad8f79a; tooling aptos-core 89cc1522)</em>';
    main.appendChild(p);
  }

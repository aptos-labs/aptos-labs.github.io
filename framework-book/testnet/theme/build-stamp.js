...
//
// The literal "2026-06-03 08:03 UTC (aptos-framework testnet 5a1d2c0; tooling aptos-core 6ea08d96)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-06-03 08:03 UTC (aptos-framework testnet 5a1d2c0; tooling aptos-core 6ea08d96)</em>';
    main.appendChild(p);
  }

...
//
// The literal "2026-05-28 07:41 UTC (aptos-framework testnet 33e99b1; tooling aptos-core d12cd172)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-05-28 07:41 UTC (aptos-framework testnet 33e99b1; tooling aptos-core d12cd172)</em>';
    main.appendChild(p);
  }

...
//
// The literal "2026-09-16 06:40 UTC (aptos-framework testnet ad8f79a; tooling aptos-core c266d21c)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-09-16 06:40 UTC (aptos-framework testnet ad8f79a; tooling aptos-core c266d21c)</em>';
    main.appendChild(p);
  }

...
//
// The literal "2026-05-21 07:38 UTC (aptos-framework testnet 33e99b1; tooling aptos-core f5bf2b45)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-05-21 07:38 UTC (aptos-framework testnet 33e99b1; tooling aptos-core f5bf2b45)</em>';
    main.appendChild(p);
  }

...
//
// The literal "2026-08-29 06:34 UTC (aptos-framework testnet ad8f79a; tooling aptos-core 0dfe6f57)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-08-29 06:34 UTC (aptos-framework testnet ad8f79a; tooling aptos-core 0dfe6f57)</em>';
    main.appendChild(p);
  }

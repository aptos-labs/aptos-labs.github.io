...
//
// The literal "2026-05-30 07:18 UTC (aptos-framework main 0a50d24; tooling aptos-core 6ded49db)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-05-30 07:18 UTC (aptos-framework main 0a50d24; tooling aptos-core 6ded49db)</em>';
    main.appendChild(p);
  }

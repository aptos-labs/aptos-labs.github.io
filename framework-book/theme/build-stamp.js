...
//
// The literal "2026-08-27 09:22 UTC (aptos-framework main 4336cdf; tooling aptos-core 1d692022)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-08-27 09:22 UTC (aptos-framework main 4336cdf; tooling aptos-core 1d692022)</em>';
    main.appendChild(p);
  }

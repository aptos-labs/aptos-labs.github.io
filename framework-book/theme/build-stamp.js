...
//
// The literal "2026-09-01 06:42 UTC (aptos-framework main 4336cdf; tooling aptos-core 885a4486)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-09-01 06:42 UTC (aptos-framework main 4336cdf; tooling aptos-core 885a4486)</em>';
    main.appendChild(p);
  }

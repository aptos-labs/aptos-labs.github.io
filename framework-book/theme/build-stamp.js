...
//
// The literal "2026-08-18 06:25 UTC (aptos-framework main 84160eb; tooling aptos-core 6426ddc1)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-08-18 06:25 UTC (aptos-framework main 84160eb; tooling aptos-core 6426ddc1)</em>';
    main.appendChild(p);
  }

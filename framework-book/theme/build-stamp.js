...
//
// The literal "2026-06-02 08:00 UTC (aptos-framework main 0a50d24; tooling aptos-core 627b9fd1)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-06-02 08:00 UTC (aptos-framework main 0a50d24; tooling aptos-core 627b9fd1)</em>';
    main.appendChild(p);
  }

...
//
// The literal "2026-06-18 08:02 UTC (aptos-framework main 7567bbc; tooling aptos-core 8edd0309)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-06-18 08:02 UTC (aptos-framework main 7567bbc; tooling aptos-core 8edd0309)</em>';
    main.appendChild(p);
  }

...
//
// The literal "2026-09-04 06:39 UTC (aptos-framework main 3e29f24; tooling aptos-core 89cc1522)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-09-04 06:39 UTC (aptos-framework main 3e29f24; tooling aptos-core 89cc1522)</em>';
    main.appendChild(p);
  }

...
//
// The literal "2026-07-29 07:10 UTC (aptos-framework main 31f3848; tooling aptos-core e2806a14)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-07-29 07:10 UTC (aptos-framework main 31f3848; tooling aptos-core e2806a14)</em>';
    main.appendChild(p);
  }

...
//
// The literal "2026-06-29 08:09 UTC (aptos-framework main 0d473ff; tooling aptos-core f3e3806f)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-06-29 08:09 UTC (aptos-framework main 0d473ff; tooling aptos-core f3e3806f)</em>';
    main.appendChild(p);
  }

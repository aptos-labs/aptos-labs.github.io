...
//
// The literal "2026-06-09 07:33 UTC (aptos-framework main 6c753e3; tooling aptos-core eec86bf6)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-06-09 07:33 UTC (aptos-framework main 6c753e3; tooling aptos-core eec86bf6)</em>';
    main.appendChild(p);
  }

...
//
// The literal "2026-08-22 06:24 UTC (aptos-framework main dc2074e; tooling aptos-core bd25d15d)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-08-22 06:24 UTC (aptos-framework main dc2074e; tooling aptos-core bd25d15d)</em>';
    main.appendChild(p);
  }

...
//
// The literal "2026-08-08 06:27 UTC (aptos-framework main d88de65; tooling aptos-core 8b6d5f9b)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-08-08 06:27 UTC (aptos-framework main d88de65; tooling aptos-core 8b6d5f9b)</em>';
    main.appendChild(p);
  }

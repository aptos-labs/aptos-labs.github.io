...
//
// The literal "2026-06-30 07:36 UTC (aptos-framework main 0d473ff; tooling aptos-core f9244fae)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-06-30 07:36 UTC (aptos-framework main 0d473ff; tooling aptos-core f9244fae)</em>';
    main.appendChild(p);
  }

...
//
// The literal "2026-09-02 06:43 UTC (aptos-framework main 3e29f24; tooling aptos-core 6fa1c244)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-09-02 06:43 UTC (aptos-framework main 3e29f24; tooling aptos-core 6fa1c244)</em>';
    main.appendChild(p);
  }

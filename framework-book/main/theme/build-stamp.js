...
//
// The literal "2026-08-17 06:25 UTC (aptos-framework main 84160eb; tooling aptos-core d8478cc8)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-08-17 06:25 UTC (aptos-framework main 84160eb; tooling aptos-core d8478cc8)</em>';
    main.appendChild(p);
  }

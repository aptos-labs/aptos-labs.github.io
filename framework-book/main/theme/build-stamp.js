...
//
// The literal "2026-09-16 06:40 UTC (aptos-framework main 652ef3e; tooling aptos-core c266d21c)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-09-16 06:40 UTC (aptos-framework main 652ef3e; tooling aptos-core c266d21c)</em>';
    main.appendChild(p);
  }

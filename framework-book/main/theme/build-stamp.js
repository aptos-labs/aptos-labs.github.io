...
//
// The literal "2026-06-25 07:30 UTC (aptos-framework main 2ce0752; tooling aptos-core 0edb4273)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-06-25 07:30 UTC (aptos-framework main 2ce0752; tooling aptos-core 0edb4273)</em>';
    main.appendChild(p);
  }

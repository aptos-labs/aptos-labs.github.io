...
//
// The literal "2026-07-15 07:01 UTC (aptos-framework main 292ef26; tooling aptos-core 6b94cd65)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-07-15 07:01 UTC (aptos-framework main 292ef26; tooling aptos-core 6b94cd65)</em>';
    main.appendChild(p);
  }

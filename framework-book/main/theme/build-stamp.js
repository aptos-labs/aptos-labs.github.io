...
//
// The literal "2026-08-26 06:25 UTC (aptos-framework main 4336cdf; tooling aptos-core 6d836bee)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-08-26 06:25 UTC (aptos-framework main 4336cdf; tooling aptos-core 6d836bee)</em>';
    main.appendChild(p);
  }

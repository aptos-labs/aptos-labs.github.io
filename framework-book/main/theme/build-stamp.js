...
//
// The literal "2026-08-24 06:27 UTC (aptos-framework main dc2074e; tooling aptos-core 872499ca)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-08-24 06:27 UTC (aptos-framework main dc2074e; tooling aptos-core 872499ca)</em>';
    main.appendChild(p);
  }

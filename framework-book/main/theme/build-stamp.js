...
//
// The literal "2026-06-10 07:50 UTC (aptos-framework main 6c753e3; tooling aptos-core eeaefbef)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-06-10 07:50 UTC (aptos-framework main 6c753e3; tooling aptos-core eeaefbef)</em>';
    main.appendChild(p);
  }

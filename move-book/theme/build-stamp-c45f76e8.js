...
//
// The literal "2026-05-08 14:37 UTC (debug build, aptos-core 348a3deec1)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-05-08 14:37 UTC (debug build, aptos-core 348a3deec1)</em>';
    main.appendChild(p);
  }

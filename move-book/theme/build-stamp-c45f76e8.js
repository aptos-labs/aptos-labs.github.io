...
//
// The literal "2026-05-15 02:58 UTC (aptos-core 14dfd48dab)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-05-15 02:58 UTC (aptos-core 14dfd48dab)</em>';
    main.appendChild(p);
  }

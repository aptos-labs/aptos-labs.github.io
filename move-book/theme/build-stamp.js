...
//
// The literal "2026-08-19 06:28 UTC (aptos-core 35b0be78 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-08-19 06:28 UTC (aptos-core 35b0be78 move-book main tip)</em>';
    main.appendChild(p);
  }

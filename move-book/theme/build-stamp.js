...
//
// The literal "2026-05-30 07:18 UTC (aptos-core 6ded49db move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-05-30 07:18 UTC (aptos-core 6ded49db move-book main tip)</em>';
    main.appendChild(p);
  }

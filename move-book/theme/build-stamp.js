...
//
// The literal "2026-06-17 08:13 UTC (aptos-core 81e6a1b6 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-06-17 08:13 UTC (aptos-core 81e6a1b6 move-book main tip)</em>';
    main.appendChild(p);
  }

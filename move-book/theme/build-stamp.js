...
//
// The literal "2026-07-23 07:07 UTC (aptos-core dea1e962 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-07-23 07:07 UTC (aptos-core dea1e962 move-book main tip)</em>';
    main.appendChild(p);
  }

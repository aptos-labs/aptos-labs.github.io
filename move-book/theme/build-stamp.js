...
//
// The literal "2026-07-15 07:01 UTC (aptos-core 6b94cd65 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-07-15 07:01 UTC (aptos-core 6b94cd65 move-book main tip)</em>';
    main.appendChild(p);
  }

...
//
// The literal "2026-07-01 07:49 UTC (aptos-core 1dbcc780 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-07-01 07:49 UTC (aptos-core 1dbcc780 move-book main tip)</em>';
    main.appendChild(p);
  }

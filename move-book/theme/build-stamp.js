...
//
// The literal "2026-09-02 06:43 UTC (aptos-core 6fa1c244 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-09-02 06:43 UTC (aptos-core 6fa1c244 move-book main tip)</em>';
    main.appendChild(p);
  }

...
//
// The literal "2026-09-22 06:40 UTC (aptos-core 050dbbe0 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-09-22 06:40 UTC (aptos-core 050dbbe0 move-book main tip)</em>';
    main.appendChild(p);
  }

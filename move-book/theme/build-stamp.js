...
//
// The literal "2026-06-16 08:20 UTC (aptos-core 57de0e01 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-06-16 08:20 UTC (aptos-core 57de0e01 move-book main tip)</em>';
    main.appendChild(p);
  }

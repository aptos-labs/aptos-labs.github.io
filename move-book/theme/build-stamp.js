...
//
// The literal "2026-07-26 07:10 UTC (aptos-core 8873921d move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-07-26 07:10 UTC (aptos-core 8873921d move-book main tip)</em>';
    main.appendChild(p);
  }

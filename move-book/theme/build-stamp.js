...
//
// The literal "2026-08-31 06:47 UTC (aptos-core 0dfe6f57 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-08-31 06:47 UTC (aptos-core 0dfe6f57 move-book main tip)</em>';
    main.appendChild(p);
  }

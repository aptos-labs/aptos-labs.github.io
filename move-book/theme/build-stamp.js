...
//
// The literal "2026-06-25 07:30 UTC (aptos-core 0edb4273 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-06-25 07:30 UTC (aptos-core 0edb4273 move-book main tip)</em>';
    main.appendChild(p);
  }

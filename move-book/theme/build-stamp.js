...
//
// The literal "2026-08-07 06:40 UTC (aptos-core a322b6ea move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-08-07 06:40 UTC (aptos-core a322b6ea move-book main tip)</em>';
    main.appendChild(p);
  }

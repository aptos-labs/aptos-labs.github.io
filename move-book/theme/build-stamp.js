...
//
// The literal "2026-08-12 06:45 UTC (aptos-core f3dbdda8 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-08-12 06:45 UTC (aptos-core f3dbdda8 move-book main tip)</em>';
    main.appendChild(p);
  }

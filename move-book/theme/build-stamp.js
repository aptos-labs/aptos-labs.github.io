...
//
// The literal "2026-06-30 07:36 UTC (aptos-core f9244fae move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-06-30 07:36 UTC (aptos-core f9244fae move-book main tip)</em>';
    main.appendChild(p);
  }

...
//
// The literal "2026-08-11 06:33 UTC (aptos-core fd5c21e3 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-08-11 06:33 UTC (aptos-core fd5c21e3 move-book main tip)</em>';
    main.appendChild(p);
  }

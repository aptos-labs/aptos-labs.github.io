...
//
// The literal "2026-07-18 06:54 UTC (aptos-core e7f5c20c move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-07-18 06:54 UTC (aptos-core e7f5c20c move-book main tip)</em>';
    main.appendChild(p);
  }

...
//
// The literal "2026-06-03 08:03 UTC (aptos-core 6ea08d96 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-06-03 08:03 UTC (aptos-core 6ea08d96 move-book main tip)</em>';
    main.appendChild(p);
  }

...
//
// The literal "2026-06-01 08:12 UTC (aptos-core 85b73187 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-06-01 08:12 UTC (aptos-core 85b73187 move-book main tip)</em>';
    main.appendChild(p);
  }

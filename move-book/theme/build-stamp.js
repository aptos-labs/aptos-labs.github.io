...
//
// The literal "2026-05-23 07:12 UTC (aptos-core d1d83dfb move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-05-23 07:12 UTC (aptos-core d1d83dfb move-book main tip)</em>';
    main.appendChild(p);
  }

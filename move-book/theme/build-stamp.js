...
//
// The literal "2026-07-02 07:24 UTC (aptos-core 75222b22 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-07-02 07:24 UTC (aptos-core 75222b22 move-book main tip)</em>';
    main.appendChild(p);
  }

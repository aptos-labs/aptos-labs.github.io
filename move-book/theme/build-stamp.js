...
//
// The literal "2026-06-02 08:00 UTC (aptos-core 627b9fd1 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-06-02 08:00 UTC (aptos-core 627b9fd1 move-book main tip)</em>';
    main.appendChild(p);
  }

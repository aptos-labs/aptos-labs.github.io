...
//
// The literal "2026-08-02 07:08 UTC (aptos-core bc5690f6 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-08-02 07:08 UTC (aptos-core bc5690f6 move-book main tip)</em>';
    main.appendChild(p);
  }

...
//
// The literal "2026-07-10 07:27 UTC (aptos-core 31ff67be move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-07-10 07:27 UTC (aptos-core 31ff67be move-book main tip)</em>';
    main.appendChild(p);
  }

...
//
// The literal "2026-09-18 06:39 UTC (aptos-core b683b501 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-09-18 06:39 UTC (aptos-core b683b501 move-book main tip)</em>';
    main.appendChild(p);
  }

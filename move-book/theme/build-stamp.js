...
//
// The literal "2026-05-31 07:34 UTC (aptos-core 85b73187 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-05-31 07:34 UTC (aptos-core 85b73187 move-book main tip)</em>';
    main.appendChild(p);
  }

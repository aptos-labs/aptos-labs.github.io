...
//
// The literal "2026-09-07 06:49 UTC (aptos-core 5f8e94a9 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-09-07 06:49 UTC (aptos-core 5f8e94a9 move-book main tip)</em>';
    main.appendChild(p);
  }

...
//
// The literal "2026-07-13 07:24 UTC (aptos-core 4d4b6c4b move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-07-13 07:24 UTC (aptos-core 4d4b6c4b move-book main tip)</em>';
    main.appendChild(p);
  }

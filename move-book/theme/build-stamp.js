...
//
// The literal "2026-07-31 07:15 UTC (aptos-core fc2f3abe move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-07-31 07:15 UTC (aptos-core fc2f3abe move-book main tip)</em>';
    main.appendChild(p);
  }

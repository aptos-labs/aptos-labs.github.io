...
//
// The literal "2026-05-25 07:55 UTC (aptos-core d1d83dfb move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-05-25 07:55 UTC (aptos-core d1d83dfb move-book main tip)</em>';
    main.appendChild(p);
  }

...
//
// The literal "2026-09-25 06:41 UTC (aptos-core ab5b6cbc move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-09-25 06:41 UTC (aptos-core ab5b6cbc move-book main tip)</em>';
    main.appendChild(p);
  }

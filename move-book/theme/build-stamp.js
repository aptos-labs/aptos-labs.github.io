...
//
// The literal "2026-08-01 07:05 UTC (aptos-core 5387a4f0 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-08-01 07:05 UTC (aptos-core 5387a4f0 move-book main tip)</em>';
    main.appendChild(p);
  }

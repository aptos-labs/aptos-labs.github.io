...
//
// The literal "2026-08-25 06:25 UTC (aptos-core a4e59c86 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-08-25 06:25 UTC (aptos-core a4e59c86 move-book main tip)</em>';
    main.appendChild(p);
  }

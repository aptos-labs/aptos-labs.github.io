...
//
// The literal "2026-08-18 06:25 UTC (aptos-core 6426ddc1 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-08-18 06:25 UTC (aptos-core 6426ddc1 move-book main tip)</em>';
    main.appendChild(p);
  }

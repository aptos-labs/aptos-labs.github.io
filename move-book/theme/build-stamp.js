...
//
// The literal "2026-09-04 06:39 UTC (aptos-core 89cc1522 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-09-04 06:39 UTC (aptos-core 89cc1522 move-book main tip)</em>';
    main.appendChild(p);
  }

...
//
// The literal "2026-09-26 06:38 UTC (aptos-core f5f07ca0 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-09-26 06:38 UTC (aptos-core f5f07ca0 move-book main tip)</em>';
    main.appendChild(p);
  }

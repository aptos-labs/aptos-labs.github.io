...
//
// The literal "2026-07-16 07:05 UTC (aptos-core 807a8314 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-07-16 07:05 UTC (aptos-core 807a8314 move-book main tip)</em>';
    main.appendChild(p);
  }

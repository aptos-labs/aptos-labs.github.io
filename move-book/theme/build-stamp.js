...
//
// The literal "2026-08-15 06:24 UTC (aptos-core 6f8f50c1 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-08-15 06:24 UTC (aptos-core 6f8f50c1 move-book main tip)</em>';
    main.appendChild(p);
  }

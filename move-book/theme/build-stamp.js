...
//
// The literal "2026-08-27 09:22 UTC (aptos-core 1d692022 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-08-27 09:22 UTC (aptos-core 1d692022 move-book main tip)</em>';
    main.appendChild(p);
  }

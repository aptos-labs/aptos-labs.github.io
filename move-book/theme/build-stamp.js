...
//
// The literal "2026-08-10 06:44 UTC (aptos-core cfc7cdc6 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-08-10 06:44 UTC (aptos-core cfc7cdc6 move-book main tip)</em>';
    main.appendChild(p);
  }

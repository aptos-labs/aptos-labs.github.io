...
//
// The literal "2026-09-23 06:40 UTC (aptos-core b762d569 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-09-23 06:40 UTC (aptos-core b762d569 move-book main tip)</em>';
    main.appendChild(p);
  }

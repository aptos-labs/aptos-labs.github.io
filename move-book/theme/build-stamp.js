...
//
// The literal "2026-06-27 07:22 UTC (aptos-core f3e3806f move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-06-27 07:22 UTC (aptos-core f3e3806f move-book main tip)</em>';
    main.appendChild(p);
  }

...
//
// The literal "2026-06-05 07:48 UTC (aptos-core e3f1cd87 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-06-05 07:48 UTC (aptos-core e3f1cd87 move-book main tip)</em>';
    main.appendChild(p);
  }

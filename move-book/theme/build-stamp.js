...
//
// The literal "2026-06-13 07:35 UTC (aptos-core 46b57c32 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-06-13 07:35 UTC (aptos-core 46b57c32 move-book main tip)</em>';
    main.appendChild(p);
  }

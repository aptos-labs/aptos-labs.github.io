...
//
// The literal "2026-09-16 06:40 UTC (aptos-core c266d21c move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-09-16 06:40 UTC (aptos-core c266d21c move-book main tip)</em>';
    main.appendChild(p);
  }

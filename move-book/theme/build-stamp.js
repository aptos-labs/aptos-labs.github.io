...
//
// The literal "2026-05-29 07:40 UTC (aptos-core 16070809 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-05-29 07:40 UTC (aptos-core 16070809 move-book main tip)</em>';
    main.appendChild(p);
  }

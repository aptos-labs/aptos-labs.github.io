...
//
// The literal "2026-08-13 06:45 UTC (aptos-core 84f2b750 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-08-13 06:45 UTC (aptos-core 84f2b750 move-book main tip)</em>';
    main.appendChild(p);
  }

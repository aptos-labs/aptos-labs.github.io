...
//
// The literal "2026-08-16 06:25 UTC (aptos-core 6f8f50c1 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-08-16 06:25 UTC (aptos-core 6f8f50c1 move-book main tip)</em>';
    main.appendChild(p);
  }

...
//
// The literal "2026-09-01 06:42 UTC (aptos-core 885a4486 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-09-01 06:42 UTC (aptos-core 885a4486 move-book main tip)</em>';
    main.appendChild(p);
  }

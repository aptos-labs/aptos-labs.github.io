...
//
// The literal "2026-05-28 07:41 UTC (aptos-core d12cd172 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-05-28 07:41 UTC (aptos-core d12cd172 move-book main tip)</em>';
    main.appendChild(p);
  }

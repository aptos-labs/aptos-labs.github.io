...
//
// The literal "2026-06-14 07:53 UTC (aptos-core 97c5e1e5 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-06-14 07:53 UTC (aptos-core 97c5e1e5 move-book main tip)</em>';
    main.appendChild(p);
  }

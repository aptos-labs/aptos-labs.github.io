...
//
// The literal "2026-09-20 06:36 UTC (aptos-core eba5dea4 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-09-20 06:36 UTC (aptos-core eba5dea4 move-book main tip)</em>';
    main.appendChild(p);
  }

...
//
// The literal "2026-07-28 07:09 UTC (aptos-core 28f82080 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-07-28 07:09 UTC (aptos-core 28f82080 move-book main tip)</em>';
    main.appendChild(p);
  }

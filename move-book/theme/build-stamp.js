...
//
// The literal "2026-06-26 07:36 UTC (aptos-core 70915349 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-06-26 07:36 UTC (aptos-core 70915349 move-book main tip)</em>';
    main.appendChild(p);
  }

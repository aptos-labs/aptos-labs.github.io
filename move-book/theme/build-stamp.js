...
//
// The literal "2026-06-18 08:02 UTC (aptos-core 8edd0309 move-book main tip)" is the placeholder that `deploy.sh` substitutes
...
(function () {
  function addStamp() {
    ...
    p.innerHTML = '<em>Build: 2026-06-18 08:02 UTC (aptos-core 8edd0309 move-book main tip)</em>';
    main.appendChild(p);
  }
